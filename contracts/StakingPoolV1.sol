    ...
    PausableUpgradeable
{
        ...
        onlyRole(REWARDER_ROLE)
    {
        ...
        // Store rewarded FurFi during last 24 hours for APY calculation
        templastStakeRewardsFurFi += amount;
        if(block.timestamp - lastStakeFurFiRewardsCall > 24 hours) {
            lastStakeFurFiRewardsDuration = block.timestamp - lastStakeFurFiRewardsCall;
            lastStakeFurFiRewardsCall = block.timestamp;
            lastStakeRewardsFurFi = templastStakeRewardsFurFi;
            templastStakeRewardsFurFi = 0;
        }
    }
        ...
        onlyRole(REWARDER_ROLE)
    {
        ...
        // Store rewarded LP during last 24 hours for APY calculation
        templastStakeRewardsLP += amount;
        if(block.timestamp - lastStakeLPRewardsCall > 24 hours){
            lastStakeLPRewardsDuration = block.timestamp - lastStakeLPRewardsCall;
            lastStakeLPRewardsCall = block.timestamp;
            lastStakeRewardsLP = templastStakeRewardsLP;
            templastStakeRewardsLP = 0;
        }
    }
    ...
    //variables to calculate apr
    uint256 public lastStakeFurFiRewardsCall;
    uint256 public lastStakeFurFiRewardsDuration;
    uint256 public lastStakeRewardsFurFi;
    uint256 private templastStakeRewardsFurFi;
    uint256 public lastStakeLPRewardsCall;
    uint256 public lastStakeLPRewardsDuration;
    uint256 public lastStakeRewardsLP;
    uint256 private templastStakeRewardsLP;
}
