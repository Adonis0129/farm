...
async function main() {
  const SDStrategyFurioFinance = await ethers.getContractFactory(
    "SDStrategyFurioFinance"
  );
  const sDStrategyFurioFinance = await upgrades.deployProxy(
    SDStrategyFurioFinance,
    [
  ...
  console.log(
    "SDStrategyFurioFinance address = ",
    sDStrategyFurioFinance.address
  );
