...
async function main() {
  const FFStrategyFurioFinance = await ethers.getContractFactory(
    "FFStrategyFurioFinance"
  );
  const fFStrategyFurioFinance = await upgrades.deployProxy(
    FFStrategyFurioFinance,
    [
  ...
  console.log(
    "FFStrategyFurioFinance address = ",
    fFStrategyFurioFinance.address
  );
